...
class MaterielTest {
    ...
    void materielProjectionFutureTest() {
        ...
        assertEquals(1000 + 1000 * 0.05, materielFutur.getValeurComptable(), 0.01, "La valeur comptable future du matériel devrait être correcte.");
    }
    ...
    void materielProjectionFutureAvantAcquisitionTest() {
        ...
        assertEquals(0, materielFutur.getValeurComptable(), "La valeur comptable avant l'acquisition devrait être 0.");
    }
}
