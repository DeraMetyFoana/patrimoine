...
public class AchatMaterielAuComptantTest {
  ...
  void testCreationAvecDeviseNonNommee() {
    ...
    AchatMaterielAuComptant achat =
        new AchatMaterielAuComptant(
            "Ordinateur", dateAchat, 1000, 0.05, new Argent("Banque", dateAchat, 10000));
  ...
  void testCreationAvecDeviseSpecifique() {
    ...
    AchatMaterielAuComptant achat =
        new AchatMaterielAuComptant(
            "Ordinateur", dateAchat, 1000, 0.05, new Argent("Banque", dateAchat, 10000), devise);
  ...
  void testFluxArgentCreation() {
    ...
    assertEquals(
        "Financement AchatMaterielAuComptant: Ordinateur",
