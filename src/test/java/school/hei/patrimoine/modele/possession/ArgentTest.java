...
public class ArgentTest {
    ...
    void argent_projectionFuture_avec_flux() {
        ...
        Possession flux = new FluxArgent("Flux", argent, dateOuverture.minusDays(1), dateFuture, -100_000, 15);
    ...
    void argentProjectionFutureTest() {
        ...
        assertEquals(1100, argentFutur.getValeurComptable(), "La valeur comptable future devrait être 1200.");
    }
}
