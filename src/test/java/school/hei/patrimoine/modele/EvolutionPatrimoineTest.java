...
class EvolutionPatrimoineTest {
  ...
  void serieValeursComptablesParPossessionPatrimoineVideTest() {
    ...
    var evolutionPatrimoine =
        new EvolutionPatrimoine(
            "Nom", patrimoineVide, LocalDate.of(2024, MAY, 1), LocalDate.of(2024, MAY, 20));

    var serieValeurs = evolutionPatrimoine.serieValeursComptablesParPossession();
    assertTrue(
        serieValeurs.isEmpty(),
        "La série des valeurs comptables doit être vide pour un patrimoine vide.");
  }
  ...
  void serieValeursComptablesParPossessionSansEvolutionTest() {
    ...
    var serieValeurs = evolutionPatrimoine.serieValeursComptablesParPossession();
    assertTrue(
        serieValeurs.containsKey(financeur),
        "La série des valeurs comptables doit contenir l'objet 'financeur'.");
    assertEquals(
        List.of(600_000),
        serieValeurs.get(financeur),
        "Les valeurs comptables du 'financeur' ne correspondent pas pour une période sans"
            + " évolution.");
  }
  ...
  void fluxArgentDepassePeriodTest() {
    ...
    var fluxArgent =
        new FluxArgent(
            ...
            15);
    var patrimoineIloAu13mai24 =
        new Patrimoine("patrimoineIloAu13mai24", ilo, au13mai24, Set.of(financeur, fluxArgent));
  ...
  void possessionsEvolutivesTest() {
    ...
    var patrimoineIloAu13mai24 =
        new Patrimoine("patrimoineIloAu13mai24", ilo, au13mai24, Set.of(financeur, materiel));
    ...
    var evolutionJournaliere = evolutionPatrimoine.getEvolutionJournaliere();
    assertTrue(
        evolutionJournaliere.get(LocalDate.of(2024, MAY, 13)).getValeurComptable() > 600_000);
    assertTrue(
        evolutionJournaliere.get(LocalDate.of(2024, MAY, 17)).getValeurComptable() > 600_000);
  }
  ...
  void possessionDateAcquisitionFutureTest() {
    ...
    var patrimoineIloAu13mai24 =
        new Patrimoine("patrimoineIloAu13mai24", ilo, futureDate, Set.of(financeur, materiel));
