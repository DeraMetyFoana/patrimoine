...
public class FluxImpossiblesTest {
  ...
  void testFluxImpossiblesCreation() {
    ...
    FluxArgent fluxArgent1 =
        new FluxArgent("Flux 1", argent, date, date, 1000, date.getDayOfMonth());
    FluxArgent fluxArgent2 =
        new FluxArgent("Flux 2", argent, date, date, 500, date.getDayOfMonth());
